...
sketchy_namey=quick_draw_data_set[random_number];
console.log(sketchy_namey);
document.getElementById("actual_sketch").innerHTML="Sketch To Be Drawn: "+sketchy_namey;
